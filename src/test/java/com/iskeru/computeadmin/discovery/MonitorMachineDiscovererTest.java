 ...
 * host-vitals catalog — one {@code monitor machine} recipe with the three read-only,
 * param-free actions cpu/memory/disk, each a fixed argv, none using sudo — proposed
...
class MonitorMachineDiscovererTest {
    ...
    void discover_ProposesMonitorMachineWithThreeReadOnlyActions() {
        ...
        assertThat(recipe.actions()).extracting(ProposedAction::name)
                .containsExactly("cpu", "memory", "disk");
